...
class Client extends DataClass implements Insertable<Client> {
  ...
  int get hashCode => Object.hash(id, name, type, idNumber, taxNumber,
      civilStatus, street, zipCode, city, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Client &&
...
class Lawsuite extends DataClass implements Insertable<Lawsuite> {
  ...
  @override
  int get hashCode => Object.hash(id, name, state, against, processNumber,
...
class Alert extends DataClass implements Insertable<Alert> {
  ...
  int get hashCode => Object.hash(
      id, title, content, type, emitted, emitAt, createdAt, metadata);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Alert &&
...
class $AlertsTable extends Alerts with TableInfo<$AlertsTable, Alert> {
  ...
  final VerificationMeta _typeMeta = const VerificationMeta('type');
  @override
  late final GeneratedColumnWithTypeConverter<AlertType, int?> type =
      GeneratedColumn<int?>('type', aliasedName, false,
              type: const IntType(), requiredDuringInsert: true)
          .withConverter<AlertType>($AlertsTable.$converter0);
  ...
  static TypeConverter<AlertType, int> $converter0 =
      const EnumIndexConverter<AlertType>(AlertType.values);
}
